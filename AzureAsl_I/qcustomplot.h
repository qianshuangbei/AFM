...
enum SelectionRectMode { srmNone    ///< The selection rect is disabled, and all mouse events are forwarded to the underlying objects, e.g. for axis range dragging
                         ...
                         ,srmRaphRect ///< Raph grap as Rect
                         ,srmRaphLine ///< Raph grap as Line
                       };
...
public:
  ...
  */
  ...
  QCP::SelectionRectMode RaphSelectMode;
...
protected:
  ...
  Q_SLOT virtual void processRaphRectSelection(QRect rect, QMouseEvent *event);
  Q_SLOT virtual void processRaphLineSelection(QRect rect, QMouseEvent *event);
